...
/-- Type quantifiers: k_ex1075780_ : Bool, k_ex1075779_ : Bool, k_ex1075778_ : Bool -/
...
/-- Type quantifiers: k_ex1075786_ : Bool, k_ex1075785_ : Bool, k_ex1075784_ : Bool -/
...
/-- Type quantifiers: k_ex1075790_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
def alignmentOrAccessFaultPriority (exc : ExceptionType) : SailM Nat := do
  ...
  | _ =>
    (internal_error "sys/mem.sail" 182
...
/-- Type quantifiers: k_ex1075907_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1075912_ : Bool, k_ex1075911_ : Bool, k_ex1075910_ : Bool, k_ex1075909_ :
...
/-- Type quantifiers: k_ex1075921_ : Bool, k_ex1075920_ : Bool, k_ex1075919_ : Bool, k_ex1075918_ :
  Bool, width : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1075975_ : Bool, k_ex1075974_ : Bool, k_ex1075973_ : Bool, k_ex1075972_ :
  Bool, width : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1075978_ : Bool, k_ex1075977_ : Bool, k_ex1075976_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex1075981_ : Bool, k_ex1075980_ : Bool, k_ex1075979_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1075984_ : Bool, k_ex1075983_ : Bool, k_ex1075982_ : Bool, width : Nat, 0
...
/-- Type quantifiers: k_ex1075995_ : Bool, k_ex1075994_ : Bool, k_ex1075993_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1076007_ : Bool, k_ex1076006_ : Bool, k_ex1076005_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1076019_ : Bool, k_ex1076018_ : Bool, k_ex1076017_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1076022_ : Bool, k_ex1076021_ : Bool, k_ex1076020_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex1076025_ : Bool, k_ex1076024_ : Bool, k_ex1076023_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
