...
/-- Type quantifiers: k_ex835856_ : Bool, k_ex835855_ : Bool, k_ex835854_ : Bool -/
...
/-- Type quantifiers: k_ex835862_ : Bool, k_ex835861_ : Bool, k_ex835860_ : Bool -/
...
/-- Type quantifiers: k_ex835866_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
          ...
          then (pure (some (← (accessFaultFromAccessType access))))
            ...
            (do
              let canAccess ← (( do
                ...
                | .Load .PageTableEntry =>
                  (do
                    assert (not res_or_con) "sys/mem.sail:100.61-100.62"
                    (pure attributes.supports_pte_read))
                | .Store .Data =>
                  (do
                    assert (not res_or_con) "sys/mem.sail:101.61-101.62"
                    (pure attributes.writable))
                | .Store .Vector =>
                  (do
                    assert (not res_or_con) "sys/mem.sail:102.61-102.62"
                    (pure attributes.writable))
...
def alignmentOrAccessFaultPriority (exc : ExceptionType) : SailM Nat := do
  ...
  | _ =>
    (internal_error "sys/mem.sail" 176
...
/-- Type quantifiers: k_ex836133_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836138_ : Bool, k_ex836137_ : Bool, k_ex836136_ : Bool, k_ex836135_ : Bool, width
...
/-- Type quantifiers: k_ex836147_ : Bool, k_ex836146_ : Bool, k_ex836145_ : Bool, k_ex836144_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836201_ : Bool, k_ex836200_ : Bool, k_ex836199_ : Bool, k_ex836198_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836204_ : Bool, k_ex836203_ : Bool, k_ex836202_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex836207_ : Bool, k_ex836206_ : Bool, k_ex836205_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836210_ : Bool, k_ex836209_ : Bool, k_ex836208_ : Bool, width : Nat, 0 <
...
/-- Type quantifiers: k_ex836221_ : Bool, k_ex836220_ : Bool, k_ex836219_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836233_ : Bool, k_ex836232_ : Bool, k_ex836231_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836245_ : Bool, k_ex836244_ : Bool, k_ex836243_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836248_ : Bool, k_ex836247_ : Bool, k_ex836246_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex836251_ : Bool, k_ex836250_ : Bool, k_ex836249_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
