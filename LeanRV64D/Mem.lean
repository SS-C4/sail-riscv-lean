...
/-- Type quantifiers: k_ex829286_ : Bool, k_ex829285_ : Bool, k_ex829284_ : Bool -/
...
/-- Type quantifiers: k_ex829292_ : Bool, k_ex829291_ : Bool, k_ex829290_ : Bool -/
...
/-- Type quantifiers: k_ex829296_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
            ...
            (do
              let canAccess ← (( do
                ...
                | .Atomic (AMOSWAP, ShadowStack, ShadowStack) =>
                  (do
                    assert res_or_con "sys/mem.sail:112.75-112.76"
...
def alignmentOrAccessFaultPriority (exc : ExceptionType) : SailM Nat := do
  ...
  | _ =>
    (internal_error "sys/mem.sail" 174
...
/-- Type quantifiers: k_ex829563_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829568_ : Bool, k_ex829567_ : Bool, k_ex829566_ : Bool, k_ex829565_ : Bool, width
...
/-- Type quantifiers: k_ex829577_ : Bool, k_ex829576_ : Bool, k_ex829575_ : Bool, k_ex829574_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829631_ : Bool, k_ex829630_ : Bool, k_ex829629_ : Bool, k_ex829628_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829634_ : Bool, k_ex829633_ : Bool, k_ex829632_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex829637_ : Bool, k_ex829636_ : Bool, k_ex829635_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829640_ : Bool, k_ex829639_ : Bool, k_ex829638_ : Bool, width : Nat, 0 <
...
/-- Type quantifiers: k_ex829651_ : Bool, k_ex829650_ : Bool, k_ex829649_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829663_ : Bool, k_ex829662_ : Bool, k_ex829661_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829675_ : Bool, k_ex829674_ : Bool, k_ex829673_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829678_ : Bool, k_ex829677_ : Bool, k_ex829676_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex829681_ : Bool, k_ex829680_ : Bool, k_ex829679_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
