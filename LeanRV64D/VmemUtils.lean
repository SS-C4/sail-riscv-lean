...
/-- Type quantifiers: k_ex834643_ : Bool, k_ex834642_ : Bool, k_ex834641_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex834677_ : Bool, k_ex834676_ : Bool, k_ex834675_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
    ...
    let loop_vars ← untilFuelM (fuel :=n) (fun (finished, i, write_success) => (pure finished)) (finished, i, write_success)
      fun (finished, i, write_success) => do
        ...
        let write_success ← (( do
          ...
          | .Ok (paddr, pbmt, _) =>
            (do
              assert (res == (is_store_conditional access)) "sys/vmem_utils.sail:213.50-213.51"
...
/-- Type quantifiers: k_ex834726_ : Bool, k_ex834725_ : Bool, k_ex834724_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
...
/-- Type quantifiers: k_ex834736_ : Bool, k_ex834735_ : Bool, k_ex834734_ : Bool, width : Nat, width
  ≥ 0, is_mem_width(width) -/
